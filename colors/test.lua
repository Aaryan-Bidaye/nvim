...
local p = {
  -- Greys (from your terminal)
  bg = '#282c34', -- OSC 11 (background)
  bg_alt = '#1d1f21', -- palette 0
  surface = '#1d1f21', -- keep floats close to palette 0
  overlay = '#3b3f4b', -- a reasonable “step up” from bg (see note below)

  fg = '#ffffff', -- OSC 10 (foreground)
  dim = '#c5c8c6', -- palette 7
  subtle = '#8a8a8a', -- halfway vibe between 8 and 7 (if you want exact-only, use #666666)
  comment = '#666666', -- palette 8

  -- Accent colors mapped directly from your palette
  cool = '#81a2be', -- palette 4 (blue)
  warm = '#f0c674', -- palette 3 (yellow)
  cyan = '#8abeb7', -- palette 6 (cyan)
  amber = '#e7c547', -- palette 11 (bright yellow)
  red = '#d54e53', -- palette 9 (bright red)
  yellow = '#b9ca4a', -- palette 10 (bright green-ish)
  green = '#b5bd68', -- palette 2
  orange = '#cc6666', -- palette 1 (since your set doesn’t have a distinct orange)
}
