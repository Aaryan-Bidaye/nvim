...
vim.keymap.set('n', '<leader>w<Right>', ':tabnext<CR>', { desc = 'Change tab to next' })
vim.keymap.set('n', '<leader>w<Left>', ':tabprev<CR>', { desc = 'Change tab to prev' })
...
--LocationListNav
vim.keymap.set('n', ']d', ':lnext<CR>', { desc = 'Next Quickfix item' })
vim.keymap.set('n', '[d', ':lprev<CR>', { desc = 'Previous Quickfix item' })
